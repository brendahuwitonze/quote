...
export class QuoteComponent implements OnInit {
  quote:Quote[]=[
    new Quote (1, 'Watch finding Nemo', 'Nelson mandela','Brendah',new Date(2020,3,14),0,0),
    new Quote(2,'Buy Cookies','I have to buy cookies for the parrot','zilfa',new Date(2019,6,9),0,0),
